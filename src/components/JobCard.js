...
export default function JobCard(props) {
  const { index, editJob, deleteJob } = props;
  const {
    job_title,
    company_name,
    industry,
  ...
  return (
    <div className="w-full rounded-xl p-4 shadow-2xl shadow-blue-200 bg-white flex">
      ...
      <div className='flex'>
        ...
        <svg onClick={() => deleteJob(index)} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
